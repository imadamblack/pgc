export const content = {
  ...
  beneficios: {
    banner: {
      ...
      description:
        'Muchas veces los proyectos de tecnología se complican porque "negocio" y "tecnología" no hablan el mismo idioma. Ahí es donde nosotros entramos.',
    },
    items: [
      {
        icon: 'globe',
  ...
  atributos: {
    banner: {
      ...
      description:
        'Una infraestructura tecnológica estable no ocurre por casualidad. Se construye con monitoreo, mantenimiento y procesos claros.',
    },
    items: [
      {
        number: '01',
        ...
        description:
          'Antes de hablar de plataformas o herramientas, analizamos cómo opera tu negocio y qué necesita realmente cada área.',
      },
      {
        number: '02',
    ...
    items: [
      {
        ...
        a: 'Sí. Con PGC es como tener tu propio equipo de IT externo: especialistas que conocen tu infraestructura y pueden resolver cualquier situación tecnológica cuando surja.',
      },
      {
      ...
      {
        q: '¿Mi empresa es demasiado pequeña para este servicio?',
        a: 'El servicio está enfocado en pequeñas y medianas empresas con hasta 50 empleados, así que somos el aliado perfecto para tu empresa.',
      },
      {
